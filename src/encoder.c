...
#ifndef CONFIG_ENCODER_LOG_LEVEL
#define ENCODER_LOG_LEVEL CONFIG_LOG_DEFAULT_LEVEL
#else
#define ENCODER_LOG_LEVEL CONFIG_ENCODER_LOG_LEVEL
#endif
LOG_MODULE_REGISTER(encoder, ENCODER_LOG_LEVEL);
